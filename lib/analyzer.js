...
//  ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝╚══════╝╚═╝   ╚══════╝╚══════╝╚═╝  ╚═╝
//
// Analyze a set of tokens and group them together based on functionality. Each
// set represents a discrete query piece.
...
module.exports = function analyzer(tokens) {
  ...
  try {
    ...
    throw new Error('Could not analyze the token set. This is most likely a problem with the analyzer and not the query. ' + err.stack);
  }
};
