...
describe('Tokenizer ::', function() {
  describe('Grouping statements with AND', function() {
    it('should generate a valid token array when AND is used as an array', function(done) {
      Tokenizer({
        expression: {
          select: ['*'],
          from: 'users',
    ...
    it('should generate a valid token array when using OR conditions with AND', function(done) {
      Tokenizer({
        expression: {
          select: ['*'],
          from: 'users',
